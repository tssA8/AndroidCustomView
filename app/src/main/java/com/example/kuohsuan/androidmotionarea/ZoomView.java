...
/**
 * Created by kuohsuan on 2017/1/26.
 */
...
public class ZoomView extends FrameLayout {
    ...
    private void processSingleTouchOnMinimap(final MotionEvent ev) {
        Log.d("AAA_ZoomView","processSingleTouchOnMinimap ");
        final float x = ev.getX();
        final float y = ev.getY();
    ...
    private void processSingleTouchOutsideMinimap(final MotionEvent ev) {
        Log.d("AAA_ZoomView","processSingleTouchOutsideMinimap");
        final float x = ev.getX();
        final float y = ev.getY();
    ...
    public void disableZoomView(Boolean disableZoom){
        disAbleZoom=disableZoom;
    }

    @Override
    protected void dispatchDraw(final Canvas canvas) {
//        Log.d("AAA_ZoomView","dispatchDraw");
        // do zoom
